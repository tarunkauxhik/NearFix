...
export default function SignInPage() {
  return (
    ...
    >
      <title>Sign In — NearFix</title>
      <meta name="description" content="Sign in to NearFix to book trusted local service providers." />
      ...
      {/* Clerk SignIn component — styled to blend with dark theme */}
